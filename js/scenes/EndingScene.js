...
class EndingScene {
    constructor(app, gameCore, uiManager) {
        ...
        this.container.zIndex = 0; // 设置为低层级
        this.type = 'ending';
        ...
        this.textContainer = new PIXI.Container(); // 新增：专用文字容器
        this.container.addChild(this.textContainer); // 将它添加到主容器
    }
    ...
    init(params = {}) {
        ...
        // 【新增】安全超时：确保15秒后无论如何都显示结局选项
        this._safetyTimeout = setTimeout(() => {
            console.warn('安全超时触发，强制显示结局选项');
